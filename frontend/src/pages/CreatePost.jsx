...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://openaitexttoimage.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: { 
  ...
  const handleSubmit = async(e) => {
    ...
    if(form.prompt && form.photo){
      setLoading(true);
      try {
        const response = await fetch('https://openaitexttoimage.onrender.com/api/v1/post', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  return (
    <section className='max-w-7x1 mx-auto'>
        <div>
            ...
            <p className='mt-2 text-[#666e765] text-[14px] max-w[500px]'>Create through collection
                of imaginative and visually stunning image generated by DALL-E AI and share them with
                the Community.
            </p>
        </div>
        <form className='mt-16 max-w-2xl' onSubmit={handleSubmit}>
                  ...
                  items-center'>
                    {form.photo ? (
                        ...
                        <img
                            src={preview}
                            alt='preview'
                            className='w-9/12 h-9/12 object-contain obacity-40'
                        />
                    )}
                    {generatingImg && (
            ...
            <div className='mt-10'>
                <p className='mt-2 text-[#666e75] text-[14px]'>
                    Once you have created the image you want, you can share it with other in 
                    the Community.
                </p>
                <button
                    type='submit'
